 ...
 * Déclare dynamiquement: Exchange, Queue, Binding et MessageConverter
 */
@Configuration
public class RabbitMQConfig {
    ...
    /**
     * Crée le binding entre l'exchange et la queue avec la routing key
     */
    @Bean
    ...
    /**
     * Configure Jackson2JsonMessageConverter pour sérialiser/désérialiser en JSON
     */
    @Bean
